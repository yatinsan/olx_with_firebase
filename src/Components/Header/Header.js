          ...
          <div class={nav ? "dropel" : 'nodis'} id="dropel">
            <div class="_3hG1N" data-aut-id="profile">
              ...
              <a class="_2c-2r" data-aut-id="loggedUser">
                <div class="_1PjtT">
                  <div class="rui-3P6Ei rui-1-t_r rui-2I-bT rui-3Rldd">
                    <span>Hello</span>,
                  </div>
                </div>
                <div class="_1dYHv">
                  <div class="rui-3P6Ei rui-CfFc1 rui-O60mi rui-1T2Y9">{user && user.displayName}</div>
                </div>
                <span class="_1HK4r">
            ...
            <a class="_1863T" rel="" data-aut-id="profileCompletion" href="/editProfile/info">
              <h3 class="rui-3P6Ei rui-CfFc1 rui-2_-SW rui-1T2Y9">1 step left</h3>
              <div class="_32Bow">
                <div class="rui-zAx7E" data-aut-id="progressBar">
                  <div data-aut-id="step" class="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" class="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" class="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" class="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" class="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" class="rui-1xby4 rui-32pBn"></div>
                </div>
              </div>
