    ...
    <div className="headerParentDiv">
      <div className="headerChildDiv">
        ...
        <div className="productSearch">
          <div className="input">
            ...
            />
            {/* <ul className='searchdown' role="listbox">
              <li><a href="">ddfsdg</a></li>
              <li><a href="">ddfsdg</a></li>
              <li><a href="">ddfsdg</a></li>
              <li><a href="">ddfsdg</a></li>
            </ul> */}
      ...
      >
        ...
        />
          ...
          <div className={nav ? "dropel" : 'nodis'} id="dropel">
            <div className="_3hG1N" data-aut-id="profile">
              ...
              <a className="_2c-2r" data-aut-id="loggedUser">
                ...
                <div className="_1dYHv">
                  <div className="rui-3P6Ei rui-CfFc1 rui-O60mi rui-1T2Y9">{user && user.displayName}</div>
                </div>
            ...
            <a className="_1863T" rel="" data-aut-id="profileCompletion" href="/editProfile/info">
              <h3 className="rui-3P6Ei rui-CfFc1 rui-2_-SW rui-1T2Y9">1 step left</h3>
              <div className="_32Bow">
                <div className="rui-zAx7E" data-aut-id="progressBar">
                  <div data-aut-id="step" className="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" className="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" className="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" className="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" className="rui-1xby4 rui-3NjYq"></div>
                  <div data-aut-id="step" className="rui-1xby4 rui-32pBn"></div>
                </div>
              </div>
              <div className="rui-3P6Ei rui-1-t_r rui-urkah rui-3Rldd">OLX is built on trust. Help other people get to know you. Tell them about the things you like.</div>
            </a>
            <div className="_1Up9t" data-aut-id="menu">
              <a className="_243cz" rel="nofollow" data-aut-id="btnProfileMyAds" href="/addProduct">
                <div className="cfoYk"><svg width="23px" height="23px" viewBox="0 0 1024 1024" data-aut-id="icon" className="" fillRule="evenodd">
                  <path className="rui-77aaa" d="M349.46 85.333h487.619l40.635 40.635v609.524l-40.635 40.635h-487.619l-40.635-40.635v-609.524l40.635-40.635zM390.095 694.857h406.35v-528.254h-406.35v528.254zM146.286 247.873l40.635-40.635 40.635 40.635v609.524h528.254l40.635 40.635-40.635 40.635h-568.889l-40.635-40.635v-650.159zM512 329.143h162.54l40.635 40.635-40.635 40.635h-162.54l-40.635-40.635 40.635-40.635zM512 491.683h81.27l40.635 40.635-40.635 40.635h-81.27l-40.635-40.635 40.635-40.635z"></path>
                </svg>
                </div>
                <span>addProduct</span>
              </a>
              <a className="_243cz" rel="nofollow" data-aut-id="btnShowBusiessPacakges" href="/payments/businesspackages/my_account">
                <div className="cfoYk"><svg width="23px" height="23px" viewBox="0 0 1024 1024" data-aut-id="icon" className="" fillRule="evenodd">
                  <path className="rui-77aaa" d="M426.667 42.667h170.667l42.667 42.667-42.667 42.667h256l42.667 42.667v768l-42.667 42.667h-682.667l-42.667-42.667v-768l42.667-42.667h256l-42.667-42.667 42.667-42.667zM213.333 896h597.333v-682.667h-597.333v682.667zM469.333 426.667v-85.333h256v85.333h-256zM298.667 426.667v-85.333h85.333v85.333h-85.333zM469.333 597.333v-85.333h256v85.333h-256zM298.667 597.333v-85.333h85.333v85.333h-85.333zM469.333 768v-85.333h256v85.333h-256zM298.667 768v-85.333h85.333v85.333h-85.333z"></path>
                </svg>
                </div>
                <span>Buy Business Packages</span>
              </a>
              <a className="_243cz" rel="" data-aut-id="btnOrdersMyOrders" href="/myorders/orders">
                <div className="cfoYk"><svg width="23px" height="23px" viewBox="0 0 1024 1024" data-aut-id="icon" className="" fillRule="evenodd">
                  <path className="rui-77aaa" d="M899.285 256l39.381 39.083v476.501l-39.381 39.083h-774.571l-39.381-39.083v-476.501l39.381-39.083h774.571zM853.461 511.573h-681.6v213.632h681.6v-213.632zM693.205 618.411h76.459l34.901 32.213-34.901 32.213h-128.896l-34.901-32.213 34.901-32.213h52.437zM853.461 341.248h-681.387v86.357l681.387-2.347v-84.053z"></path>
                </svg>
                </div>
                <span>Bought Packages &amp; Billing</span>
              </a>
              <a href="https://help.olx.in/hc/en-us" target="_blank" rel="noopener noreferrer" className="_243cz aTsM5" data-aut-id="btnProfileHelp">
                <div className="cfoYk"><svg width="23px" height="23px" viewBox="0 0 1024 1024" data-aut-id="icon" className="" fillRule="evenodd">
